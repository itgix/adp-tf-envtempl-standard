module "wafv2_application" {
  source                           = "git::git@github.com:itgix/tf-module-wafv2.git?ref=v7"
  ...
  ip_whitelist_forwarded_ip_config = var.waf_ip_whitelist_forwarded_ip_config # forwarded IP config for the IP whitelist
}
